...
class ResponseGenerator:
    ...
    def build_prompt(self, decision):
       return f"""
You are a professional support assistant for a non-profit organization.

Your task is to write a high-quality, human-like response email.
...
- Adapt tone based on urgency:
  - high → urgent, reassuring, immediate action
  - medium → attentive and responsive
